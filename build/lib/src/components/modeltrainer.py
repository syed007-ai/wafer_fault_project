...
class ModelTrainer :
    ...
    def initiate_model_trainer(self, train_array, test_array, preprocessor_path) :
        try :
            logging.info(f"Splitting into training and testing input and target feature")
            ...
            ## Tpo get best model name from dict
            ...
            logging.info("Error Occurred in initiate_model_trainer method of modeltrainer module")
